                ...
                for (let j = 0; j < objectValue.length; j++) {
                    ...
                    for (let i = 0; i < fieldList.length; i++) {
                        ...
                        if (i == 0) {
                            ...
                            let headerVal = "";
                            if (
                                fieldList[i].apiName != undefined &&
                                fieldList[i].apiName.indexOf(".") != -1
                            ) {
                                let parentTree =
                                    fieldList[i].apiName.split(".");
                                if (
                                    parentTree.length > 1 &&
                                    objectValue[j].hasOwnProperty(
                                        [parentTree[0]][parentTree[1]]
                                    )
                                )
                                    headerVal =
                                        objectValue[j][parentTree[0]][
                                            parentTree[1]
                                        ];
                            }
                            if (headerVal != "") a.innerHTML = headerVal;
                            else
                                a.innerHTML =
